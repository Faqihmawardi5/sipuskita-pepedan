...
<head>
  ...
  <title><?php echo $title_web;?> | SIPUSDAN </title>
  ...
  <link rel="stylesheet" href="<?= base_url('assets_style/css/custom-sidebar.css'); ?>">
...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="<?php echo base_url('index.php/dashboard');?>" class="logo">
      ...
      <span class="logo-mini"><img src="<?= base_url('assets_style/image/logo_perpus.png'); ?>" alt="Logo" style="height: 25px; vertical-align: middle; margin-right: 8px;"></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">
        <img src="<?= base_url('assets_style/image/logo_perpus.png'); ?>" alt="Logo" style="height: 25px; vertical-align: middle; margin-right: 8px;">
        <b>SIPUSKITA</b>
      </span>
    </a>
